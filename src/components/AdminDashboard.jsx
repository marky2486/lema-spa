...
className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'services'
? 'bg-[#8b7355] text-white shadow-sm'
: 'text-gray-600 hover:bg-gray-100'
}`}
>
...
className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'gift-cards'
? 'bg-[#8b7355] text-white shadow-sm'
: 'text-gray-600 hover:bg-gray-100'
}`}
>
...
className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'therapists'
? 'bg-[#8b7355] text-white shadow-sm'
: 'text-gray-600 hover:bg-gray-100'
}`}
>
...
title="Manage Users"
className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'management'
? 'bg-[#8b7355] text-white shadow-sm'
: 'text-gray-600 hover:bg-gray-100'
}`}
>

        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="bg-[#f5f1ed] p-6 rounded-md border border-[#e5ddd5] space-y-4">
            ...
            <div className="space-y-2">
                ...
                <span>{appliedDiscount.percentage >= 28.57 && appliedDiscount.percentage <= 28.58 ? 'Senior Citizen Discount – VAT‑exempt' : `Discount (${appliedDiscount.percentage}%)`}</span>                      <span>-₱{discountAmount.toLocaleString()}</span>
                    </motion.div>
                  )}
                </AnimatePresence>
